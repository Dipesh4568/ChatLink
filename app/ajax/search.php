<?php
    ...
    if(isset($_SESSION['username'])){
        # check if the key is subbmitted
        if(isset($_POST['key'])){
            ...
            <?php } } else{ ?>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" class="bi bi-person-exclamation" viewBox="0 0 16 16">
